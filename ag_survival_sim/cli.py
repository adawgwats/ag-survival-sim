...
def run_iowa_maize_demo_cli() -> None:
    ...
    parser.add_argument("--cash", type=float, default=250000.0, help="Initial farm cash.")
    parser.add_argument("--debt", type=float, default=0.0, help="Initial farm debt.")
    parser.add_argument("--credit-limit", type=float, default=175000.0, help="Initial credit limit.")
    parser.add_argument("--acres", type=float, default=200.0, help="Farm acreage.")
    parser.add_argument("--land-value-per-acre", type=float, default=5860.0, help="Initial land value per acre.")
    parser.add_argument("--land-financed-fraction", type=float, default=0.2, help="Fraction of initial land cost financed by mortgage.")
