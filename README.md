...
- benchmark-ready DSSAT bundles for maize, soybean, and wheat
...
- converts DSSAT `HWAM` output from `kg/ha` into crop-specific bushels per acre for the finance model
